DROP
DATABASE IF EXISTS `yozu_nacos`;

CREATE
DATABASE  `yozu_nacos` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
values (1, 'application-dev.yml', 'DEFAULT_GROUP',
       ...
       (5, 'yozu-system-dev.yml', 'DEFAULT_GROUP',
        ...
        '', '', '系统模块', 'null', 'null', 'yaml', '', ''),
       (6, 'yozu-gen-dev.yml', 'DEFAULT_GROUP',
        ...
        '', '', '代码生成', 'null', 'null', 'yaml', '', ''),
       (7, 'yozu-job-dev.yml', 'DEFAULT_GROUP',
        ...
        '', '', '定时任务', 'null', 'null', 'yaml', '', ''),
       (8, 'yozu-file-dev.yml', 'DEFAULT_GROUP',
