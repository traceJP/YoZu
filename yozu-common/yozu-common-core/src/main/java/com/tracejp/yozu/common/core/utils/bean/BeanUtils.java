package com.tracejp.yozu.common.core.utils.bean;

import com.tracejp.yozu.common.core.exception.UtilException;
...
public class BeanUtils extends org.springframework.beans.BeanUtils {
     ...
     * @throws UtilException if newing target instance failed or copying failed
     */
    @Nullable
     ...
     * @throws UtilException if copying failed
     */
    public static void updateProperties(@NonNull Object source, @NonNull Object target) {
        ...
        try {
            ...
            throw new UtilException("Failed to copy properties", e);
        }
    }
